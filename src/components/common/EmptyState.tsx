  ...
  <div className={`text-center py-12 px-6 ${className}`}>
    ...
    {action && (
      <button
        ...
        className="mt-4 inline-flex items-center justify-center gap-1.5 rounded-2xl px-5 py-2.5 text-white text-sm font-bold active:scale-95 transition-transform"
