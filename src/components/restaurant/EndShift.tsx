  ...
  if (submitted) {
    return (
      <div className="screen-enter flex flex-col items-center justify-center min-h-[70vh] text-center gap-4 px-4">
        ...
        <h2 className="text-2xl font-black text-gray-900">׳”׳׳©׳׳¨׳× ׳”׳¡׳×׳™׳™׳׳”! נ‰</h2>
        <p className="text-gray-500">׳”׳“׳™׳¨׳•׳’ ׳ ׳©׳׳— ֲ· ׳×׳©׳׳•׳ ׳¢׳•׳‘׳“</p>
        <div className="bg-amber-50 rounded-2xl px-8 py-4 w-full text-center">
          <div className="text-3xl font-black text-amber-600">ג‚×{totalCharged}</div>
    ...
    <div className="screen-enter space-y-4">
      ...
      <div className="bg-gradient-to-br from-gray-900 to-gray-800 text-white rounded-2xl p-5">
        <div className="flex items-center gap-3 mb-4">
          ...
          <div>
            ...
            <div className="text-gray-400 text-sm">
              {job?.Role || '׳¢׳•׳‘׳“'} ֲ· {shiftHours.toFixed(1)} ׳©׳¢׳•׳×
            </div>
          </div>
        </div>
        <div className="grid grid-cols-3 gap-3 text-center">
          ...
          <div className="bg-white/10 rounded-xl p-3">
            <div className="font-black text-xl text-green-400">ג‚×{baseAmount.toFixed(0)}</div>
            <div className="text-gray-400 text-xs">׳׳¢׳•׳‘׳“</div>
          </div>
        </div>
      </div>
      ...
      <div className="bg-white rounded-2xl p-4 card-shadow">
        ...
        <div className="space-y-0">
          {[
            { label: `׳©׳›׳¨ ׳‘׳¡׳™׳¡׳™ (ג‚×${hourlyRate} ֳ— ${shiftHours.toFixed(1)} ׳©׳³)`, value: `ג‚×${baseAmount.toFixed(0)}`, color: 'text-gray-800' },
            { label: '׳¢׳׳׳× ׳₪׳׳˜׳₪׳•׳¨׳׳” (6.5%)',                                       value: `ג‚×${restaurantCommission.toFixed(0)}`, color: 'text-gray-800' },
          ].map(r => (
          ...
          <div className="flex justify-between pt-3">
            ...
            <span className="font-black text-amber-500 text-lg">ג‚×{totalCharged}</span>
          </div>
        </div>
        <div className="mt-3 bg-amber-50 rounded-xl p-3 flex justify-between items-center">
          <span className="text-gray-500 text-sm">׳™׳×׳¨׳” ׳׳׳—׳¨ ׳×׳©׳׳•׳</span>
          <span className="font-bold text-amber-500">
            ג‚×{Math.max(walletBalance - parseFloat(totalCharged), 0).toLocaleString()}
          </span>
        </div>
      </div>
      ...
      {/* ׳“׳™׳¨׳•׳’ ׳¢׳•׳‘׳“ */}
      <div className="bg-white rounded-2xl p-4 card-shadow">
        <h3 className="font-bold text-gray-800 mb-1">׳“׳¨׳’ ׳׳× {workerName}</h3>
        <p className="text-gray-400 text-xs mb-3">׳”׳“׳™׳¨׳•׳’ ׳׳©׳₪׳™׳¢ ׳¢׳ ׳”׳ ׳¨׳׳•׳× ׳©׳ ׳”׳¢׳•׳‘׳“ ׳‘׳₪׳׳˜׳₪׳•׳¨׳׳”</p>
