  ...
  if (submitted) {
    return (
      <div className="screen-enter flex flex-col items-center justify-center min-h-[70vh] text-center gap-4 px-4">
        ...
        <div className="bg-orange-50 rounded-2xl px-8 py-4 w-full text-center">
          <div className="text-3xl font-black text-orange-600">₪{totalCharged}</div>
  ...
  return (
    <div className="screen-enter space-y-4">
      ...
      <div className="bg-white rounded-2xl p-4 card-shadow">
        ...
        <div className="mt-3 bg-orange-50 rounded-xl p-3 flex justify-between items-center">
      ...
      <div className="bg-white rounded-2xl p-4 card-shadow">
        ...
        <textarea
          ...
          rows={2}
          className="w-full mt-3 border border-gray-200 rounded-xl p-3 text-sm text-right resize-none focus:border-orange-400 outline-none"
        />
      </div>
